...
function App() {
    ...
    const exportToExcel = () => {
        ...
        portfolios.forEach(portfolio => {
            ...
            const assetData = [
                ...
                ['Valor de Mercado:', `R$ ${portfolio.marketValue.toLocaleString('pt-BR', {minimumFractionDigits: 2})}`, '', 'Preço Médio:', `R$ ${portfolio.averagePrice?.toFixed(4) || '0.00'}`, '', '', '', '', '', ''],
            ...
            assetData.push([
                ...
                `Preço Médio: R$ ${portfolio.averagePrice?.toFixed(4) || '0.0000'}`,
    ...
    const exportSingleAsset = () => {
        ...
        const assetData = [
            ...
            ['RESUMO FINANCEIRO', '', '', '', '', '', '', '', '', ''],
            ['─────────────────────────────────────────────────────────────────────', '', '', '', '', '', '', '', '', ''],
                            ['Posição Atual:', `${portfolio.currentPosition.toLocaleString('pt-BR')} cotas`, '', 'Preço Médio de Compra:', `R$ ${portfolio.averagePrice?.toFixed(4) || '0.0000'}`, '', '', '', '', ''],
